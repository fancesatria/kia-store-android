...
import com.project.ecommmerce_2.databinding.ActivityShippedOrderBinding;
...
public class ShippedOrder extends AppCompatActivity {

    private ActivityShippedOrderBinding bind;
    private SPHelper sp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bind = ActivityShippedOrderBinding.inflate(getLayoutInflater());
        setContentView(bind.getRoot());

        sp = new SPHelper(this);

        bind.item.setLayoutManager(new LinearLayoutManager(this));
        orderAdapter = new FilterOrderAdapter(ShippedOrder.this, data);
    ...
    public void fetchData() {
        ...
        Call<List<OrderModel>> karyaGetRespCall = API.getRetrofit(this).getShipped(sp.getIdPengguna());
        karyaGetRespCall.enqueue(new Callback<List<OrderModel>>() {
            ...
            public void onResponse(Call<List<OrderModel>> call, Response<List<OrderModel>> response) {
                ...
                if (response.isSuccessful()) {
                    if (response.body() == null || response.body().isEmpty()) {
                        Toast.makeText(ShippedOrder.this, getString(R.string.no_data), Toast.LENGTH_SHORT).show();
                    } else {
                        data.clear();
                    ...
                    ErrorDialog.message(ShippedOrder.this, getString(R.string.cant_access), bind.getRoot());
                }
            }
            ...
            public void onFailure(Call<List<OrderModel>> call, Throwable t) {
                LoadingDialog.close();
                ErrorDialog.message(ShippedOrder.this, getString(R.string.trouble), bind.getRoot());
//                Toast.makeText(ShippedOrder.this, t.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
    }
